    ...
    public function importFromCsvFile() {
        ...
        while (($row = fgetcsv($file, 1000, ",")) !== FALSE) {
            try{
                ...
                echo "New data imported successfully! </br>";
            } catch(Exception $e) {
